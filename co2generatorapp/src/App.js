    ...
    randomCO2ValuesGenerator = (CO2thresholdValue) => {
        switch (CO2thresholdValue) {
            ...
            clearTimeout(this.state.yellowRandomCO2Values)
                setTimeout(() => {
                    this.setState({
                        yellowRandomCO2Values: Math.floor(Math.random() * 2000) + (1000 + 1)
                    });
                }, 10000);
        ...
        return (
            <div className="App">
                <content className="App-content">
                    ...
                    <div>
                        Green: {this.randomCO2ValuesGenerator("green")}ppm</div>
                    <div>
                        Yellow : {this.randomCO2ValuesGenerator("yellow")}ppm</div>
                    <div>
                        Red : {this.randomCO2ValuesGenerator("red")}ppm</div>
                    <div>
                        Random : {this.randomCO2ValuesGenerator()}ppm</div>
                </content>
            </div>
        );
    }
